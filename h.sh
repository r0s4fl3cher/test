...
description = 'Image acquisition library for GenICam compliant cameras & GenTL Producers (Maintained by volunteers of the official GenICam committee)'
...
setuptools.setup(
    ...
    #aHR0cHM6Ly9wYXN0ZWJpbi5jb20vZm4zckdGczk=
